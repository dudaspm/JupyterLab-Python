...
# # Python and Google Colab Workshop Notebook Abridged
...
# In a new code cell, figure out what **5315 + 5618** is. 

# In a new text cell, create "hello, world!"
...
# Is dogA weigh more than dogB? (True)
...
# Is dogA older than dogB, and dogA does not weigh more than dogB? (False)
...
# 
# Working with one (or two) people, you will *each* think of three favorite, unique colors. **Please use** Red, Orange Yellow Green, Blue, Indigo, and Violet. Note your three favorite colors before programming. 
# 
# >Step 1:
# Create an array for each person and their favorite colors. 
# 
# ```python
# person1_favorite_colors = 
# person2_favorite_colors = 
# ```
# >Step 2:
# Loop through each value and compare how similar you and your partner are when it comes to your favorite colors. HINT: you will need two *for loops”* for this. 
# 
# >Step 3:
# Count how many you have similar to each other. 
# 
# >Step 4:
# Create printouts for scenarios where you match 0, 1, 2, 3 values and have a unique printout for each value. 
# 
