...
# > Q: Can I run Matlab in Jupyter Lab?
# 
# > A: Yes, techincally, here is a link (https://github.com/Calysto/matlab_kernel) to a project that has made this available. I did not try out this out, because I am not familiar with Matlab.
# 
# ***
